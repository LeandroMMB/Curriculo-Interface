...
namespace Currículo
{
    public partial class Frm_Cadastro : Form
    {
        ...
        private void Lbl_LoginEmVezDisso_Click(object sender, EventArgs e)
        {
            Close();
        }
        ...
        private void Btn_Salvar_Click(object sender, EventArgs e)
        {
            ...
            if (Txt_Usuario.Text.Trim() != "" && Txt_Senha.Text.Trim() != "" && Txt_Confirmar.Text.Trim() != "")
            {
                if (Txt_Senha.Text == Txt_Confirmar.Text)
                {
                    if (Cls_LoginCadastroSenha.SalvarDados(Txt_Usuario.Text, Txt_Senha.Text))
                    {
                        Close();
                    }
                }
                ...
                {
                    Lbl_DigiteSenha.Text = "As senhas não são iguais. Tente novamente";
                }
            }
        }
